  ...
  return (
    <section className="py-16 px-4 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground uppercase mb-8">{t.title}</h2>
          ...
          {t.products.map((product, index) => (
            ...
            >
              <CardContent className="p-0">
                <Link href={`/product/${index + 3}`} className="pointer-events-auto">
                    ...
                    <div className="flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Image
                          ...
                          width={16}
                          height={16}
                          className={`h-4 w-4 ${i < Math.floor(product.rating) ? "opacity-100" : "opacity-20"}`}
                        />
                      ))}
